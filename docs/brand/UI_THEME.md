...
The favicon is `public/favicon.png` (the heron on white, 64 px) with
`public/apple-touch-icon.png` at 180 px; both are generated by
`docs/brand/render.mjs`'s sibling script from `docs/brand/heron-engraving.png`.
...
- `.logo`: an `<img src="/brand/heron.png">` at 38 px tall next to the word in `var(--font-wordmark)` (Libre Caslon Text 700, letter-spacing `.10em`, 22 px, navy). Applied.
